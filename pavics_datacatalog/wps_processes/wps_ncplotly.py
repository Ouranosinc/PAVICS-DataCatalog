    ...
    def __init__(self):
        ...
        inputs = [LiteralInput('opendap_url',
                  ...
                  LiteralInput('variable_name',
                               ...
                               data_type='string'),
                  LiteralInput('time_initial_indice', # index ou indices
                               'Time start index',
                               abstract='Initial index for time dimension.',
                               data_type='integer',
                               min_occurs=0),
                  LiteralInput('time_final_indice',
                               'Time stop index',
                               abstract='Final index for time dimension.',
                               data_type='integer',
                               min_occurs=0),
                  LiteralInput('level_initial_indice',
                               'Vertical level start index',
                               abstract='Initial index for vertical level dimension',
                               data_type='integer',
                               min_occurs=0),
                  LiteralInput('level_final_indice',
                               'Vertical level stop index',
                               abstract='Final index for vertical level dimension',
                               data_type='integer',
                               min_occurs=0),
